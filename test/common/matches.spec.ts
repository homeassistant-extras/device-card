    ...
    describe('matchesPattern', () => {
      ...
      describe('exact matching', () => {
        it('should match identical strings', () => {
          expect(matchesPattern('light.living_room', 'light.living_room')).to.be
            .true;
          expect(matchesPattern('sensor.temperature', 'sensor.temperature')).to
            .be.true;
        ...
        it('should not match different strings', () => {
          ...
          expect(matchesPattern('sensor.temperature', 'sensor.humidity')).to.be
            .false;
          expect(
            matchesPattern('device_tracker.phone', 'device_tracker.tablet'),
          ).to.be.false;
        });
      ...
      describe('wildcard matching', () => {
        it('should match with prefix wildcards', () => {
          expect(matchesPattern('light.living_room', '*living_room')).to.be
            .true;
          expect(matchesPattern('switch.living_room', '*living_room')).to.be
            .true;
          expect(matchesPattern('sensor.living_room', '*living_room')).to.be
            .true;
        });
        ...
        it('should require all non-wildcard parts to match', () => {
          expect(
            matchesPattern('sensor.bedroom_humidity', 'sensor.*temperature'),
          ).to.be.false;
          expect(
      ...
      describe('regex matching', () => {
        it('should match basic regex patterns', () => {
          expect(matchesPattern('light.living_room', '/light\\.living_room/'))
            .to.be.true;
        ...
        it('should match regex patterns with character classes', () => {
          expect(matchesPattern('light.room1', '/light\\.room[0-9]/')).to.be
            .true;
          expect(matchesPattern('light.room9', '/light\\.room[0-9]/')).to.be
            .true;
        ...
        it('should match regex patterns with anchors', () => {
          ...
          expect(matchesPattern('sensor.temperature_celsius', '/celsius$/')).to
            .be.true;
          expect(matchesPattern('sensor.temperature_fahrenheit', '/celsius$/'))
            .to.be.false;
        });
        ...
        it('should handle complex regex patterns', () => {
          ...
          expect(matchesPattern('esp_living_airfresh', '/esp_.*_airfresh/')).to
            .be.true;
        ...
        it('should handle invalid regex patterns gracefully', () => {
          ...
          expect(matchesPattern('light.living_room', '/light\\.(living|/')).to
            .be.false;
          expect(
      ...
      describe('edge cases', () => {
        ...
        it('should handle patterns with special characters', () => {
          ...
          expect(matchesPattern('switch.$kitchen', 'switch.$kitchen')).to.be
            .true;

          // Test with wildcards and special characters
          expect(matchesPattern('sensor.temp+humidity', 'sensor.*+*')).to.be
            .true;
          expect(matchesPattern('sensor.temp+pressure', 'sensor.*+*')).to.be
            .true;
          expect(matchesPattern('sensor.temp-humidity', 'sensor.*+*')).to.be
            .false;
        });
      ...
      describe('real-world examples', () => {
        ...
        it('should handle entity ID patterns', () => {
          expect(matchesPattern('sensor.bedroom_uptime', '*_uptime')).to.be
            .true;
